...
class SecondView extends StatefulHookConsumerWidget {
  const SecondView({super.key});
  static const routeName = 'second-view';
          ...
          TextButton.icon(
              ...
              onPressed: () async {
                ...
                temp == "First Done"
                    ...
                    : context.goNamed("results", params: {'sol': temp});
              },
